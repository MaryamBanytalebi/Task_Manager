...
public class SwipeableRecyclerView implements RecyclerView.OnItemTouchListener {
    ...
    public SwipeableRecyclerView(RecyclerView recyclerView, SwipeListener listener) {
    ...
    /**
     * The callback interface used by {@link SwipeableRecyclerView} to inform its client
